    ...
    <SocketProvider namespace="containers">
      <header className="text-center mx-4 px-4 sm:px-6 lg:px-8">
        <div className="relative w-full rounded-lg px-4">
          <div className="mx-auto max-w-lg my-5 md:my-10 font-bold tracking-tight flex flex-col sm:flex-row items-center justify-center gap-2 text-center">
            <span className="text-5xl md:text-6xl lg:text-7xl text-green-600">
              {t('campusNamePrefix')}
            </span>
            <PointerHighlight
            ...
            >
              <span className="relative z-10 text-5xl md:text-6xl lg:text-7xl break-words">
                {t('campusNameSuffixSustainable')}
              </span>
            </PointerHighlight>
          </div>
        </div>
